...
binop_expr :
  ...
  | binop_expr PLUS binop_expr { EPrim2(EP2 Plus, $1, $3, full_span()) }
  | binop_expr MINUS binop_expr { EPrim2(EP2 Minus, $1, $3, full_span()) }
  | binop_expr TIMES binop_expr { EPrim2(EP2 Times, $1, $3, full_span()) }
  | binop_expr AND binop_expr { EPrim2(LP2 And, $1, $3, full_span()) }
  | binop_expr OR binop_expr { EPrim2(LP2 Or, $1, $3, full_span()) }
  | binop_expr GREATER binop_expr { EPrim2(EP2 Greater, $1, $3, full_span()) }
  | binop_expr GREATEREQ binop_expr { EPrim2(EP2 GreaterEq, $1, $3, full_span()) }
  | binop_expr LESS binop_expr { EPrim2(EP2 Less, $1, $3, full_span()) }
  | binop_expr LESSEQ binop_expr { EPrim2(EP2 LessEq, $1, $3, full_span()) }
  | binop_expr EQEQ binop_expr { EPrim2(EP2 Eq, $1, $3, full_span()) }
  | const { $1 }
