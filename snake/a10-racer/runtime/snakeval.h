...
#define BOOL_TAG_MASK    0x0000000000000007UL
#define NUM_TAG_MASK     0x0000000000000001UL
#define TUPLE_TAG_MASK   0x0000000000000007UL
#define CLOSURE_TAG_MASK 0x0000000000000007UL
#define FWD_PTR_TAG_MASK 0x0000000000000007UL

/// Tag prefixes of specific type encodings
#define BOOL_TAG    0x0000000000000007UL
